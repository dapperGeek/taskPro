    ...
    <div class="container-sm m-auto border-1">
        ...
        <form action="{{ route('projects.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input name="title" type="text" class="form-control" id="titleInput" aria-describedby="">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <textarea name="description" type="text" class="form-control" id="descInput" aria-describedby=""></textarea>
            </div>
